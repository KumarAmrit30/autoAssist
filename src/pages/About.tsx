      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <section className="text-center mb-16">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              ...
              We're passionate about helping you make informed decisions when it
              comes to choosing your perfect vehicle.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              ...
              enjoyable experience. Our mission is to provide you with the most
              comprehensive, accurate, and up-to-date information about cars,
              helping you make decisions that perfectly match your needs,
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why Choose AutoAssist?</h2>
        ...
        <section className="text-center">
          <div className="max-w-2xl mx-auto bg-automotive-gradient p-8 rounded-lg text-primary-foreground">
            ...
            <p className="text-lg mb-6 opacity-90">
              Join thousands of satisfied users who have found their dream cars
              with AutoAssist
            </p>
